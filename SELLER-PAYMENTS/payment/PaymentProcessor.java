...
public class PaymentProcessor {
    ...
    public List<Payment> updatePayments(List<Payment> paymentList, double lumSumAmount, int afterEmiCount,
            int emiAmount, double totalAmount) {
        if (afterEmiCount == 0) {
    ...
    public List<Payment> processFirstPayment(List<Payment> paymentList, double totalAmount, double lumSumAmount,
            int emiAmount) {
