...
public class Over {
    ...
    private Over(@Nonnegative int inningsNumber, @Nonnegative int overNumber, Player striker, Player nonStriker,
            Balls balls, Player bowler,
            @Nonnegative int ballsInOver, @Nullable Instant startTime) {
    ...
    /**
     * @return The zero-indexed number of this over (e.g. the first over in an
     *         innings returns 0)
     */
    ...
    /**
     * @return The number of runs gained by the team in this over (including
     *         extras).
     */
    ...
    /**
     * @return True if no runs have been scored from the bat or as bowling extras in
     *         this over.
     *         If not {@link #isComplete()} then returns false even if there are no
     *         runs so far.
     */
    ...
    /**
     * @return True if there shouldn't be any more balls bowled in this over. Note
     *         that it is still possible to have
     *         more balls in this over even if it is complete if there is an
     *         umpiring error.
     */
