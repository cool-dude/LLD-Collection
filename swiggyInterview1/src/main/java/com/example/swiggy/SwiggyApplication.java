...
public class SwiggyApplication {
	...
	public static void main(String[] args) {
		...
		AssignDeliveryExecutiveStrategy assignDeliveryExecutiveStrategy = new SwiggyDeliveryStrategy(
				deliveryExecutiveScoreCalculationStrategy);
		DeliveryExecutiveAssignmentServie deliveryExecutiveAssignmentServie = new DeliveryExecutiveAssignmentServie(
				assignDeliveryExecutiveStrategy);
