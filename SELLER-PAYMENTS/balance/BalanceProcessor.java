...
public class BalanceProcessor {
    ...
    public void displayBalance(List<Payment> paymentList, int afterEMICount, String bankName, String customerName) {
        ...
        System.out.println(bankName + " " + customerName + " " + (int) (payment.getAmountPaid()) + " "
                + payment.getEmiCountLeft());
    }
    ...
    public List<Payment> updatePayments(List<Payment> paymentList, int afterEmiCount, int emiAmount,
            double totalAmount) {
